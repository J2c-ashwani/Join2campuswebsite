export const countriesData = [
  ...
  },
  {
    ...
    universities: "18+ Partner Universities",
  ...
  },
  {
    ...
    universities: "22+ Partner Universities",
    students: "350+ Students Placed",
  },
  {
    name: "Italy",
    flag: "/flags/it.png",
    ...
    universities: "16+ Partner Universities",
    students: "280+ Students Placed",
  },
  {
    name: "Poland",
    flag: "/flags/pl.png",
    ...
    universities: "14+ Partner Universities",
    students: "220+ Students Placed",
  },
  {
    name: "Portugal",
    flag: "/flags/pt.png",
  ...
  },
  {
    ...
    universities: "11+ Partner Universities",
    students: "160+ Students Placed",
  },
  {
    name: "Austria",
    flag: "/flags/at.png",
  ...
  },
  {
    ...
    universities: "7+ Partner Universities",
    students: "100+ Students Placed",
  },
  {
    name: "Sweden",
    flag: "/flags/se.png",
...
export const globalNetworkData = [
  {
    ...
    description: "Our largest market with extensive consultant network across major cities",
  },
  {
    country: "Nepal",
    flag: "/flags/np.png",
    consultants: "45+",
    students: "800+",
    cities: ["Kathmandu", "Pokhara", "Lalitpur", "Chitwan", "Nepalgunj"],
  ...
  },
  {
    ...
    description: "Growing network serving Sri Lankan students seeking European education",
  },
  {
    country: "Ghana",
    flag: "/flags/gh.png",
    ...
    description: "Expanding African operations with focus on quality European pathways",
  },
  {
    country: "Philippines",
    flag: "/flags/ph.png",
    ...
    description: "Strategic partnership network serving Filipino students",
  },
]
...
export const teamData = [
  {
    ...
    image: "/images/team/ashwani-kumar.jpg",
    bio: "Ashwani Kumar leads Join2Campus with a vision to make international education accessible and transparent. With strong expertise in student recruitment and global partnerships, he ensures students receive the right guidance from admission to visa success.",
  },
  {
    name: "Chetan Jangir",
    title: "Co-founder & Admission Director",
    image: "/images/team/chetan-jangir.jpg",
    bio: "Chetan Jangir drives admissions at Join2Campus with a focus on student success. His expertise ensures smooth application processes and personalized guidance for every aspiring student.",
  },
  {
    name: "Shubham Rai",
    title: "Founding Member & Head of Key Accounts",
    image: "/images/team/shubham-rai.jpg",
    bio: "Shubham Rai plays a key role in building and nurturing strong partnerships at Join2Campus. With his expertise in relationship management, he ensures smooth collaboration with our global partners to create the best opportunities for students.",
  },
  {
    name: "Abhishek Kumar",
    title: "Visa & Immigration Specialist",
    image: "/images/team/abhishek-kumar.png",
    bio: "Abhishek Kumar specializes in booking VFS appointments and guiding students in preparing their visa documents, ensuring a smooth and hassle-free visa process.",
  },
  {
    name: "Dheeraj Jha",
...
export const partnershipBenefits = [
  {
    ...
    description: "Access to 285+ education consultants across 5 countries",
    icon: "🌍",
  },
  {
    title: "High Volume Recruitment",
    description: "6,200+ students placed annually across 16 European destinations",
    icon: "📈",
  },
  {
    title: "Dedicated Support Team",
    description: "Professional account management and marketing support",
    icon: "🤝",
  },
  {
    title: "Proven Track Record",
    description: "98% visa success rate with comprehensive pre-departure support",
    icon: "✅",
  },
  {
    title: "Multi-Country Presence",
    description: "Operations across India, Nepal, Sri Lanka, Ghana, and Philippines",
    icon: "🏢",
  },
  {
    title: "Quality Assurance",
    description: "Rigorous partner screening and continuous quality monitoring",
    icon: "⭐",
  },
]
